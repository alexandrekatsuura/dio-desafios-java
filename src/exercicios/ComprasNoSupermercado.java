...
/*
    ...
    Entrada
    A primeira linha de entrada contém um inteiro N (N < 100)
    com a quantidade de casos de teste que vem a seguir, ou melhor,
...
public class ComprasNoSupermercado {
    public static void Executar() {
        ...
        for(int i =0; i < entradas; i++){
            ...
            List lista = Arrays.asList(entrada.split(" "));
            Set set = new HashSet<String>(lista);
            lista = new ArrayList();
            lista.addAll(set);
        ...
        for(Object lista: todas){
           ((List) lista).stream().forEach( a -> System.out.print(a + " "));
            System.out.println();
        }
    }
}
